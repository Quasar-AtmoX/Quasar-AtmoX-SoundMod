...
cp -f "/system/framework/com.sonyericsson.dlna.playanywhere.jar" "/data/quasar-atmox/backup/framework/"
...
cp -f "/system/lib/libsony_audioroute.so" "/data/quasar-atmox/backup/lib/"
cp -f "/system/lib/libsony_audioutils.so" "/data/quasar-atmox/backup/lib/"
...
cp -f "/system/lib/libwebrtc_audio_preprocessing.so" "/data/quasar-atmox/backup/lib/"
